package com.logistical.fd.widget.view;
...
//        canvas.translate(20,30);偏移位置，防止遮挡
        ...
        for (int i = 0; i < nodeProgressAdapter.getCount(); i++) {
            ...
            if (i == 0) {
                ...
                mPaint.setColor(getResources().getColor(R.color.colorLoginDark));
                //画文字
                mPaint.setTextSize(35);
                canvas.drawText(((LogisticsData)data.get(i)).getTime()+"", left * 2 + nodeRadius * 2 + 10, (i + 1) * nodeInterval + top - 10, mPaint);
//                canvas.drawText("不换行", left * 2 + nodeRadius * 2 + 10, i * nodeInterval + top + (nodeInterval / 3), mPaint);
                //文字换行
                TextPaint textPaint = new TextPaint();
                textPaint.setColor(getResources().getColor(R.color.colorLoginDark));
                ...
                canvas.drawText(((LogisticsData) data.get(i)).getTime() + "", left * 2 + nodeRadius * 2 + 10, (i + 1) * nodeInterval + top - 10, paint);
                //文字换行
                TextPaint textPaint = new TextPaint();
